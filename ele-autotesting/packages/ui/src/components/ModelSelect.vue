<template>
  <div class="relative">
    <button @click.stop="toggleDropdown" class="theme-template-select-button" :disabled="disabled">
    ...
    <div v-if="isOpen" class="theme-dropdown" :style="dropdownStyle" @click.stop v-click-outside="() => (isOpen = false)">
      <div class="p-2 max-h-64 overflow-y-auto">
        ...
        <div
          ...
          :class="[modelValue === model.key ? 'theme-dropdown-item-active' : 'theme-dropdown-item-inactive']"
        >
          <div class="flex items-center justify-between">
