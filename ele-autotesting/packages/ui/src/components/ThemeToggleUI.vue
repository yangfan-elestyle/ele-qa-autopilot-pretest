<template>
  <button class="theme-icon-button" title="主题切换" aria-label="主题切换" @click="toggleTheme">
    ...
    <span class="text-sm max-md:hidden truncate">{{ isDark ? '夜间模式' : '日间模式' }}</span>
  </button>
</template>
...
const { theme, toggleTheme } = useTheme(services)
